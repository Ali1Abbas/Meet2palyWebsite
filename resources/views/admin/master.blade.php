...
<div class="top-bar primary-top-bar">
    <div class="container-fluid">
        <div class="row">
            <div class="col">
                <a class="admin-logo d-none" href="{{ route('admin.dashboard') }}">
                    <h1>
                        <img style="width: 165px;" alt="logo" src="{{ CustomHelper::appSetting('application_setting','logo') }}" class="toggle-none hidden-xs">
                    </h1>
                </a>
                <div class="left-nav-toggle d-none" >
                    <a  href="#" class="nav-collapse"><i class="fa fa-bars"></i></a>
                </div>
                <div class="left-nav-collapsed d-none" >
                    <a  href="#" class="nav-collapsed"><i class="fa fa-bars"></i></a>
                </div>
                <ul class="list-inline top-right-nav">
                    <li class="dropdown icons-dropdown d-none">
                    ...
                    <li class="dropdown avtar-dropdown">
                        <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                            <img alt="" class="rounded-circle" src="{{ !empty( CustomHelper::currentUser()->image_url) ? Storage::url( CustomHelper::currentUser()->image_url) : asset('admin/assets/img/avtar-2.png') }}" width="30">
    ...
    <div class="nano">
        <div class="nano-content sidebar-nav">
            <div class="card-body border-bottom text-center nav-profile">
                ...
                <img alt="profile" class="margin-b-10" src="{{ !empty( CustomHelper::currentUser()->image_url) ? Storage::url( CustomHelper::currentUser()->image_url) : asset('admin/assets/img/avtar-2.png') }}" width="80">
