...
class AdvertisementHook
{
   ...
   */
    ...
    */
    ...
    {
        $postdata['slug'] = uniqid(uniqid());
        if( !empty($postdata['image']) ){
            $postdata['image'] = CustomHelper::uploadMedia('advertisements',$postdata['image']);
        }
    }
    ...
    */
    ...
    public function create_cache_signature($request)
    {
        ...
        return 'AdvertisementHook' . md5(implode('',$cache_params));
    }
}
