...
class CmsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $admin_role_id = $this->addCmsRoleAdmin();
        $this->addCmsAdmin($admin_role_id);
        $this->addCmsModules();
        $this->addModulePermissions($admin_role_id);
        $this->mailTemplates();
        $this->user_group();
    ...
    public function addCmsRoleAdmin()
    {
        $role_id = \DB::table('cms_roles')->insertGetId([
            'name'           => 'Admin',
            'slug'           => Str::slug('Admin'),
    ...
    public function addModulePermissions($role_id)
    {
        \DB::table('cms_module_permissions')->insert([
            'cms_role_id' => $role_id,
            'cms_module_id'        => 3,
            'is_add'    => '1',
            'is_view'        => '1',
    ...
    public function addCmsAdmin($role_id)
    {
        \DB::table('cms_users')->insert([
            'cms_role_id' => $role_id,
            'name'        => 'meet2play',
            'username'    => 'meet2play',
            'slug'        => 'meet2play',
            'email'       => 'admin@meet2play.com',
            'mobile_no'   => '1-8882051816',
            'password'    => Hash::make('meet@123$'),
            'created_at'  => Carbon::now(),
        ]);
    }
    ...
    public function addCmsModules()
    {
        $data = [
            ...
            [
                'parent_id'    => 0,
                'name'         => 'Advertisement',
                'route_name'   => 'advertisement.index',
                'icon'         => 'fa fa-cog',
                'status'       => '1',
                'sort_order'   => 3,
                'created_at'   => Carbon::now()
