                        ...
                        <form method="post" action="" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                @if( !empty(CustomHelper::appSetting('application_setting','logo')) )
                                    <img style="width: 150px; height: 80px; object-fit: contain" src="{{ CustomHelper::appSetting('application_setting','logo') }}">
                                @endif
                            </div>
                            <div class="form-group">
                                <label>Favicon</label>
                                ...
                                @if( !empty(CustomHelper::appSetting('application_setting','favicon')) )
                                    <img style="width:60px; height: 60px; object-fit: contain" src="{{ CustomHelper::appSetting('application_setting','favicon') }}">
                                @endif
                            </div>
                            <div class="form-group">
